...
exports.run = (client, message, args) => {
   ...
   var kisi = message.mentions.members.first() || client.users.resolve(args[0]) || client.users.cache.find(u => u.username === args[0]) || client.users.cache.get(args[0]); 
     ...
     if (!message.member.hasPermission("BAN_MEMBERS")) {
        const yetkinyok = new discord.MessageEmbed()
          .setDescription("**<:no:972887999140462652> Herhangi Bir Kişi Banlamak İçin `Üyeleri Engelle` İznine Sahip Olmalısın!**")
          .setColor("RED")
    ...
    .setDescription("**<:no:972887999140462652> Belirttiğiniz Kişi Sunucuda Yok Veya Banlamak İçin Herhangi Bir Kişi Belirtmedin!**")
    .setColor("RED")
  ...
  if(message.member.roles.highest.comparePositionTo(message.mentions.members.first().roles.highest) <= 1) {
   ...
   .setDescription("**<:no:972887999140462652> Bu Kişi Sunucu Sahibi Onu Banlayamazsın!**")
   .setColor("RED")
   return message.channel.send(arkadaşownermış) 
       ...
       .setDescription("**<:no:972887999140462652> Herhangi Bir Kişi Banlamak İçin `Üyeleri Engelle` İznine Sahip Olmalıyım!**")
       .setColor("RED")
 ...
 .setDescription("**<:no:972887999140462652> Bu Kişiyi Banlayamam!**")
 .setColor("RED")
   ...
   sebepp = sebeb
         ...
         try {
          ...
          kisi.send(sucembeddm)
           ...
           .setDescription(`<:yes:972887997504696430> ${kisi} **Adlı Kullanıcı ${sebepp} Sebebi İle Banlandı.**`)
           .setColor("GREEN")
